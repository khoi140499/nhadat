...
public class ChuaDuyet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_chua_duyet, container, false);
        re=v.findViewById(R.id.recycle_chuaduyet);
    ...
    private void setListImage(List<ParseObject> list) {
        ...
        for (ParseObject as:list){
            imagePosts.add(new com.example.nhadat_app.Model.ImagePost(as.getParseObject("post_id"),
                    as.getParseFile("img").getUrl()+""));
        }

        for(com.example.nhadat_app.Model.ImagePost as:imagePosts){
